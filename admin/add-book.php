...
{ 
    if(isset($_POST['add']))
    {
        ...
        $isbn=$_POST['isbn'];
        //$price=$_POST['price'];
        $sql="INSERT INTO  tblbooks(BookName,CatId,AuthorName,ISBNNumber) VALUES(:bookname,:category,:author,:isbn)";
...
<head>
    ...
    <title>PESU MCA Library Management System | Add Book</title>
...
<body>
    ...
    <div class="col-md-12">
    <h4 class="header-line" style="text-align: center;">Add Book</h4>
    </div>
    </div>
    <div class="row">
    ...
    <form role="form" method="post">
        ...
        <input class="form-control" type="text" name="bookname" autocomplete="off"  required autofocus />
        </div>
