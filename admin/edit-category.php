...
<head>
    ...
    <title>PESU MCA Library Management System | Edit Categories</title>
...
<body>
    ...
    <form role="form" method="post">
        ...
        if($query->rowCount() > 0)
        {
            ...
            { ?>
            <div class="radio">
            <label><input type="radio" name="status" id="status" value="0" checked="checked">Inactive</label>
            </div>
            <div class="radio"><label><input type="radio" name="status" id="status" value="1">Active</label>
            </div>
        <?php } ?>
        </div>-->
        <?php }} ?>
        <button type="submit" name="update" class="btn btn-info">Update </button>
        <a href="manage-categories.php" class="btn btn-danger btn-dm" role="button" aria-pressed="true">Cancel</a>
    </form>
    </div>
    </div>
    </div>
