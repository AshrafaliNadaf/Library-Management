...
{ 
    if(isset($_POST['issue']))
    {
        ...
        $sql="INSERT INTO  tblissuedbookdetails(EmpId,BookId,bid) VALUES(:EmpId,:bookid,:bookdetails)";
...
<body>
	...
	<form role="form" method="post">
		...
		<?php
		    ...
		    $result=mysqli_query($con,"select * from tblstaff");
		    echo "<center>";
		    echo "<select class='form-control' name='EmpId' id='EmpId' onBlur='getstaff()'   autocomplete='off' required='required'>>";
	        echo "<option>";
	        echo "</option>";
		...
		<div class="form-group">
		<span><label><b>Staff Name :</b></label></span>
		<select  class="form-control" name="staffdetails" id="get_staff_name" readonly></select>
 		</div>
